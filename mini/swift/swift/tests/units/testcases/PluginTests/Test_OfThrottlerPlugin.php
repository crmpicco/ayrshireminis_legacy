...
class Test_OfThrottlerPlugin extends UnitTestCase
{
   ...
   */
  function &getWorkingMockConnection($send=1, $duplicate=false, $conn=null)
  {
    $count = 0;
    if ($conn === null) $conn =& new FullMockConnection($this);
  ...
  function testBytesPerMinuteThrottling()
  {
  ...
  function testEmailsPerMinuteThrottling()
  {
