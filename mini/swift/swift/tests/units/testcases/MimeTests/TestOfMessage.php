...
class GeneralTestOfMessage extends UnitTestCase
{
   ...
   */
  function testMessageContainsNeededHeaders()
  {
   ...
   */
  function testRecipientHeadersCanBeAListOfAddresses()
  {
   ...
   */
  function testUTF8CharsetIsUsedIfDetectedUnlessOverridden()
  {
    $msg =& new Swift_Message();
    $msg->setBody("cenvéla");
    $structure =& $msg->build();
   ...
   */
  function testFlowedFormattingCanBeTurnedOnOrOff()
  {
    $msg =& new Swift_Message();
  ...
  function testPriorityCanBeSet()
  {
    ...
    $msg->setPriority(SWIFT_MESSAGE_PRIORITY_HIGH);
    $structure =& $msg->build();
    $structure = $structure->readFull();
    $this->assertPattern("~X-Priority: 1\r\nX-MSMail-Priority: High~s", $structure);
    ...
    $msg->setPriority(SWIFT_MESSAGE_PRIORITY_NORMAL);
    $structure =& $msg->build();
    $structure = $structure->readFull();
    $this->assertPattern("~X-Priority: 3\r\nX-MSMail-Priority: Normal~s", $structure);
    ...
    $msg->setPriority(SWIFT_MESSAGE_PRIORITY_LOW);
    $structure =& $msg->build();
    $structure = $structure->readFull();
   ...
   */
  function testPriorityIsAdjustedIfSetTooHighOrLow()
  {
    for ($i = -10; $i < 1; $i++)
    {
      $msg =& new Swift_Message();
      $msg->setPriority($i);
      $this->assertEqual(SWIFT_MESSAGE_PRIORITY_HIGH, $msg->getPriority());
      $structure =& $msg->build();
      $structure = $structure->readFull();
      $this->assertPattern("~X-Priority: 1\r\nX-MSMail-Priority: High~s", $structure);
    }
    ...
    for ($i = 15; $i > 5; $i--)
    {
      $msg =& new Swift_Message();
      $msg->setPriority($i);
      $this->assertEqual(SWIFT_MESSAGE_PRIORITY_LOW, $msg->getPriority());
      $structure =& $msg->build();
      $structure = $structure->readFull();
      $this->assertPattern("~X-Priority: 5\r\nX-MSMail-Priority: Low~s", $structure);
    }
   ...
   */
  function testReadReceiptHeadersAreSetIfRequested()
  {
    $msg =& new Swift_Message();
   ...
   */
  function testBodyBecomesMimeWarningInMultipartMessages()
  {
    $msg =& new Swift_Message();
...
class TestOfMessageWithSubParts extends UnitTestCase
{
   ...
   */
  function testContentTypeIsMultipartAlternative()
  {
    $msg =& new Swift_Message();
    $msg->attach(new Swift_Message_Part("foobar"));
    $structure =& $msg->build();
   ...
   */
  function testSubPartsAreNestedCorrectly()
  {
    $msg =& new Swift_Message();
    $msg->attach(new Swift_Message_Part("foobar"));
    $msg->attach(new Swift_Message_Part("zipbutton", "text/html"));
   ...
   */
  function testHtmlPartsAlwaysAppearAfterPlainParts()
  {
    $msg =& new Swift_Message();
    $msg->attach(new Swift_Message_Part("foobar"));
    $msg->attach(new Swift_Message_Part("zipbutton", "text/html"));
   ...
   */
  function testPartsCanBeDetached()
  {
    $msg =& new Swift_Message();
   ...
   */
  function testDetatchingAllParts()
  {
    $msg =& new Swift_Message();
    $id1 = $msg->attach(new Swift_Message_Part("foo"));
    $id2 = $msg->attach(new Swift_Message_Part("bar", "text/html"));
...
class TestOfMessageWithAttachments extends UnitTestCase
{
   ...
   */
  function testContentTypeIsMultipartMixed()
  {
    $msg =& new Swift_Message();
   ...
   */
  function testDetatchingAllAttachments()
  {
    $msg =& new Swift_Message();
...
class TestOfMessageWithSubPartsAndAttachments extends UnitTestCase
{
   ...
   */
  function testContentTypeIsMixedIfPartsAndAttachmentsAdded()
  {
    $msg =& new Swift_Message();
    $msg->attach(new Swift_Message_Attachment("foobar"));
   ...
   */
  function testMessageIsCorrectlyStructured()
  {
    $msg =& new Swift_Message();
    $msg->attach(new Swift_Message_Attachment("foobar"));
    $msg->attach(new Swift_Message_Part("foo"));
   ...
   */
  function testMessageRemainsCorrectlyStructuredWhenPartsAreAddedAfterCompilation()
  {
    $msg =& new Swift_Message();
    $msg->attach(new Swift_Message_Attachment("foobar"));
    $msg->attach(new Swift_Message_Part("foo"));
   ...
   */
  function testPartsCanBeDetatched()
  {
    $msg =& new Swift_Message();
   ...
   */
  function testDetachingAllSubParts()
  {
    $msg =& new Swift_Message();
    $id1 = $msg->attach(new Swift_Message_Part("some part"));
    $id2 = $msg->attach(new Swift_Message_Part("another part"));
...
class TestOfMessageWithEmbeddedFiles extends UnitTestCase
{
   ...
   */
  function testMimeTypeIsRelated()
  {
    $msg =& new Swift_Message();
    ...
    $msg->attach(new Swift_Message_EmbeddedFile(new Swift_File($GLOBALS["CONF"]->FILES_PATH . "/manchester.jpeg")));
    $this->assertEqual("multipart/related", $msg->getContentType());
    $structure =& $msg->build();
    $structure = $structure->readFull();
    $this->assertPattern("~(.(?!\r\n\r\n))*?\r\nContent-Type: multipart/related;\\s* boundary=.*~", $structure);
...
class TestOfMessageWithSubPartsAndEmbeddedFiles extends UnitTestCase
{
   ...
   */
  function testRemovingAllSubParts()
  {
    $msg =& new Swift_Message();
   ...
   */
  function testRemovingAllEmbeddedFiles()
  {
    $msg =& new Swift_Message();
    $id1 = $msg->attach(new Swift_Message_EmbeddedFile("foo"));
    $id2 = $msg->attach(new Swift_Message_Part("test"));
...
class TestOfMessageWithAttachmentsAndEmbeddedFiles extends UnitTestCase
{
   ...
   */
  function testRemovingAllAttachments()
  {
    $msg =& new Swift_Message();
    $id1 = $msg->attach(new Swift_Message_EmbeddedFile("foo"));
    $id2 = $msg->attach(new Swift_Message_Attachment("test"));
...
class TestOfMessage extends GroupTest
{
   ...
   */
  function TestOfMessage()
  {
    parent::GroupTest("TestOfMessage");
