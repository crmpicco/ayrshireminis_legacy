...
class TestOfEncoder extends UnitTestCase
{
  ...
  {
    $str_encoded = $this->_encoder->base64Encode(file_get_contents($GLOBALS["CONF"]->FILES_PATH . "/manchester.jpeg"), 76);
    $file_encoded = $this->_encoder->base64EncodeFile(new Swift_File($GLOBALS["CONF"]->FILES_PATH . "/manchester.jpeg"), 76);
  ...
  {
    $data = file_get_contents($GLOBALS["CONF"]->FILES_PATH . "/manchester.jpeg");
  ...
  {
    $iso88591 = file_get_contents($GLOBALS["CONF"]->FILES_PATH . "/encodings/iso-8859-1.txt");
    $this->assertFalse($this->_encoder->isUTF8($iso88591));
    
    $utf8 = file_get_contents($GLOBALS["CONF"]->FILES_PATH . "/encodings/utf-8.txt");
