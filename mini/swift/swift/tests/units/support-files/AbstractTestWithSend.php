 ...
 * @author Chris Corbyn <chris@w3style.co.uk>
 */
class AbstractTestWithSend extends UnitTestCase
{
  /**
   ...
   */
  function &getWorkingMockConnection($send=1, $conn=null, $reconnect_at=0, $max_reconnect=0, $duplicate=false)
  {
    $count = 0;
    if (!$conn) $conn =& new FullMockConnection($this);
