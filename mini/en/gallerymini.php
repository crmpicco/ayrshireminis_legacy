...
if (is_numeric($_GET["id"])) {
	$result = mysql_query("SELECT id, submissionid, cardesc, category, image, externalimage, year, moreinfo, city, country FROM `ayrshire_mini`.`gallery` WHERE id = '$imageid'") or die(mysql_error());
			...
			<table border="0" cellpadding="5" cellspacing="0" width="100%">
				...
				<tr>
					...
					?>
							...
							<?php } ?>
							<?php
								// default the more info text to 'None' if there has not been anything entered
					...
					?>
						...
						<div align="center" class="text_small_dark">
