...
function lookup(country) {
    if(country.length == 0) {
        ...
        $.post("autocompletelocation.php", {location: ""+country+""}, function(data){
            if(data.length >0) {
                $("#suggestions").show();
					...
					<td><span class="heading"><a href="/mini/en/contact.php">Contact</a></span><br>
						...
						<div class="question">
							<table width="80%" align="center">
								...
								<tr>
									<td class="text_head">Where Are You From? <span class="text_head_small">(suggestion provided)</span></td>
									<td>
										<div>
											<div><input size="30" id="country" name="country" onkeyup="lookup(this.value);" type="text" class="textbox"/></div>  
