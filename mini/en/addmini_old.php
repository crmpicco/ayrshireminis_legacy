...
echo "CARDESC: $cardesc<br>";
echo "YEAR: $year<br>";
echo "CATEGORY: $category<br>";
echo "MEMBER: $member<br>";
echo "FILENAME: $filename<br>";
echo "EXTERNAL IMAGE: $externalimage<br>";
echo "MORE INFO: $moreinfo<br>";
echo "PROCESS: $process<br>";
echo "MOREIMAGES1: " . $_POST["moreimage1"]. "<br>";
echo "MOREIMAGES2: " . $_POST["moreimage2"]. "<br>";
echo "MOREIMAGES3: " . $_POST["moreimage3"]. "<br>";
echo "</b></font>";
*/
#$val = "£";
#$val = str_replace("£", "&#163;", $val);

#echo "<font color=white>VAL: " . $val . "</font>";

if (isset($country)) {
	$userfrom = explode("|", $country);
}

#echo ", $splitdata[1], $splitdata[2], $splitdata[3], $splitdata[4]";
